...
window.addEventListener('load', (event) => {
  ...
  if (!status) {
    ...
    setTimeout(() => {
      ...
      originalTwo.innerHTML = window.length['pd-5x' + lenght]
      discTwo.innerHTML = window.compareLength['pd-5x' + lenght]
    ...
    setTimeout(() => {
      ...
      originalTwo.innerHTML = window.length['5x' + lenght]
      discTwo.innerHTML = window.compareLength['5x' + lenght]
...
window.addEventListener('load', (event) => {
  ...
  originalTwo.innerHTML = window.length['5x4ft(1.2m)']
  discTwo.innerHTML = window.compareLength['5x4ft(1.2m)']
