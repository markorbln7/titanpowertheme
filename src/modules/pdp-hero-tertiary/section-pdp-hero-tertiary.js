...
if (!!allShopSections.length) {
    allShopSections.forEach((section) => {
        ...
        function updateTotalPrice() {
            ...
            mainProductPrice.textContent = totalMainProductPrice.toLocaleString('en-US', { style: 'currency', currency: currency });
            mainComparePrice.textContent = totalMainComparePrice.toLocaleString('en-US', { style: 'currency', currency: currency });
        }
